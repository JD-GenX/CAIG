...
class BaseDPOTrainer(LLaVATrainer):
    """
    ...
    def __init__(
        ...
        pcpo_weight: Optional[float] = 1,
        pcpo_beta: Optional[float] = 0.5,
    ):
        self.is_encoder_decoder = is_encoder_decoder
        self.pcpo_weight = pcpo_weight
        self.pcpo_beta = pcpo_beta
        ...
        if disable_dropout:
            ...
            # if self.pretrain_ref_model is not None:
            #     disable_dropout_in_model(self.pretrain_ref_model)
    ...
    def get_batch_metrics(**kwargs):
        """Compute the PPO loss and other metrics for the given batch of inputs for train or test."""
        raise NotImplementedError
